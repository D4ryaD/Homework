...
Для этого необходимо зайти на сайт https://github.com/
Создать учетную запись. После этого создать новый репозиторий. Для преобразования репозитория из локального в удаленный репозиторий необходимо использовать следующие функуции: 
git remote add origin (с указанием ссылки на сетевой репозиторий)
git branch -M master
